...
Bez zaglądania do kodu źródłowego trudno zweryfikować, ile jest w tym prawdy. Niemniej wiadomo, że architektura modułowa jest czymś pożądanym, bo umożliwia liczne modyfikacje sposobu działania systemu (tj. wysoka elastyczność) i otwiera go na dalszy rozwój.
